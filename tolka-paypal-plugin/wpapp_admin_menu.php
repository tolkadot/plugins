...
///@ tolkadot - 27July2016 - edited to accept 7 inupt fields rather than 6
...
function paypal_payment_options_page() {
    ...
    if (isset($_POST['info_update'])) {
        ...
        $value7 = filter_input(INPUT_POST, 'wp_pp_payment_value7', FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
        ...
        update_option('wp_pp_payment_value6', $value6);
         update_option('wp_pp_payment_item7', sanitize_text_field($_POST["wp_pp_payment_item7"]));
        update_option('wp_pp_payment_value7', $value7);
    ...
    <?php _e('<option value="HKD"') ?><?php if ($paypal_payment_currency == "HKD") echo " selected " ?><?php _e('>Hong Kong Dollar</option>') ?>
                    ...
                    <tr valign="top"><td width="25%" align="left">
                            <strong>Payment Option 1 - Make an appointment Price only :</strong>
                        </td><td align="left">
                    ...
                    <tr valign="top"><td width="25%" align="left">
                            <strong>Payment Option 2  - Training Session Price only :</strong>
                        </td><td align="left">
                    ...
                    <tr valign="top"><td width="25%" align="left">
                            <strong>Payment Option  3 -   Training Session Price only :</strong>
                        </td><td align="left">
                    ...
                    <tr valign="top"><td width="25%" align="left">
                            <strong>Payment Option 4 - Training Session Price only :</strong>
                        </td><td align="left">
                    ...
                    <tr valign="top"><td width="25%" align="left">
                            <strong>Payment Option 5 - Training Session Price only:</strong>
                        </td><td align="left">
                    ...
                    <tr valign="top"><td width="25%" align="left">
                            <strong>Payment Option 6 - Training Session Price only:</strong>
                        </td><td align="left">
                        ...
                        <tr valign="top"><td width="25%" align="left">
                            <strong>Payment Option 7 - Training Session Price only:</strong>
                        </td><td align="left">
                            <input name="wp_pp_payment_item7" type="text" size="25" value="<?php echo esc_attr(get_option('wp_pp_payment_item7')); ?>"/>
                            <strong>Price :</strong>
                            <input name="wp_pp_payment_value7" type="text" size="10" value="<?php echo esc_attr(get_option('wp_pp_payment_value7')); ?>"/>
                ...
                <table style="width:50%; border-spacing:0; padding:0; text-align:center;">
                    <tr>
                        <td>
    <?php _e('<input type="radio" name="payment_button_type" value=https://www.paypalobjects.com/webstatic/en_US/i/btn/png/silver-rect-paypal-34px.png') ?>
    <?php if ($payment_button_type == "https://www.paypalobjects.com/webstatic/en_US/i/btn/png/silver-rect-paypal-34px.png") echo " checked " ?>
    <?php _e('/>') ?>
                        </td>
                       
                    </tr>
                    <tr>
                        <td><img border="0" src="https://www.paypalobjects.com/webstatic/en_US/i/btn/png/silver-rect-paypal-34px.png" alt="" /></td>
                        </tr>
                </table>
